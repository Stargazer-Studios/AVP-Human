...
public class HumanCavePlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> registry) {
        ...
        registry.register(HumanPlacedFeatureKeys.AUTUNITE_GEODE, createAutuniteGeodePlacement(configuredFeatureLookup));
    }
    ...
    private static PlacedFeature createAutuniteGeodePlacement(HolderGetter<ConfiguredFeature<?, ?>> configuredFeatureLookup) {
        ...
        return new PlacedFeature(configuredFeatureLookup.getOrThrow(HumanCaveConfigurations.AUTUNITE_GEODE), modifiers);
    }
}
