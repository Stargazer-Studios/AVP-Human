...
import com.human.common.data.loot.CommissaryGiftLootTable;
...
public class VillagerLootTableProvider extends SimpleFabricLootTableProvider {
    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> biConsumer) {
        biConsumer.accept(HumanVillagerGiftKeys.COMMISSARY_GIFT_LOOT_TABLE, CommissaryGiftLootTable.LOOT_TABLE.apply(provider));
    }
}
