...
public class IndustrialCategory implements DisplayCategory<IndustrialDisplay> {
    ...
    public static final ResourceLocation TEXTURE = HumanResources.location("textures/gui/container/industrial_furnace_gui.png");

    public static final CategoryIdentifier<IndustrialDisplay> INDUSTRIAL_FURNACE =
        CategoryIdentifier.of(Human.MOD_ID, "industrial_furnace_gui");
    ...
    public Component getTitle() {
        return HumanBlocks.INDUSTRIAL_FURNACE.get().getName();
    }

    @Override
    public Renderer getIcon() {
        return EntryStacks.of(HumanBlockItems.INDUSTRIAL_FURNACE_BLOCK.get().getDefaultInstance());
    }
