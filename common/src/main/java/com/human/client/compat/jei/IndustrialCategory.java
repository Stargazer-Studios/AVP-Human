...
public class IndustrialCategory implements IRecipeCategory<IndustrialFurnaceRecipe> {
    ...
    public @NotNull RecipeType<IndustrialFurnaceRecipe> getRecipeType() {
        return HumanJEIPlugin.INDUSTRIAL_FURNACE_TYPE;
    }
    ...
    public @Nullable IDrawable getIcon() {
        return guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(HumanBlocks.INDUSTRIAL_FURNACE.get()));
    }
