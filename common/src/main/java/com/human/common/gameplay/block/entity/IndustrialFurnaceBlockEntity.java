...
import com.human.mixin.AbstractFurnaceBlockEntityInvoker;
...
public class IndustrialFurnaceBlockEntity extends AbstractFurnaceBlockEntity {
    ...
    public IndustrialFurnaceBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(HumanBlockEntityTypes.INDUSTRIAL_FURNACE.get(), blockPos, blockState, HumanRecipes.INDUSTRIAL_FURNACE_RECIPE_TYPE.get());
    }
