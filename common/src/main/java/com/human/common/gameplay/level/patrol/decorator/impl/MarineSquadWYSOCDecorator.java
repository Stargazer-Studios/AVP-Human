...
public class MarineSquadWYSOCDecorator implements MarineSquadDecorator {

    public static final MarineSquadWYSOCDecorator INSTANCE = new MarineSquadWYSOCDecorator();

    private MarineSquadWYSOCDecorator() {}
    ...
    public void decorate(Level level, List<Marine> marines) {
        ...
        for (var marine : marines) {
            equipArmorItem(marine, HumanArmorItems.WY_COMMANDO_HELMET.get(), dyeColor);
            equipArmorItem(marine, HumanArmorItems.WY_COMMANDO_CHESTPLATE.get(), dyeColor);
            equipArmorItem(marine, HumanArmorItems.WY_COMMANDO_LEGGINGS.get(), dyeColor);
            equipArmorItem(marine, HumanArmorItems.WY_COMMANDO_BOOTS.get(), dyeColor);
        }
    }
