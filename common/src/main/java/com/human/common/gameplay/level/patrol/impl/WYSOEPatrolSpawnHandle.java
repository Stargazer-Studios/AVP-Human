...
import com.human.common.gameplay.level.patrol.decorator.impl.MarineSquadWYSOEDecorator;
...
public class WYSOEPatrolSpawnHandle {
    ...
    private void spawn(Level level, Player player, BlockPos.MutableBlockPos mutableBlockPos) {
        ...
        MarineSquadWYSOEDecorator.INSTANCE.decorate(level, spawnedMarines);
    }
}
