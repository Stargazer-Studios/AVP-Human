...
import com.human.common.gameplay.level.patrol.decorator.impl.MarineSquadWYSOCDecorator;
...
public class WYSOCPatrolSpawnHandle {
    ...
    private void spawn(Level level, Player player, BlockPos.MutableBlockPos mutableBlockPos) {
        ...
        MarineSquadWYSOCDecorator.INSTANCE.decorate(level, spawnedMarines);
    }
}
